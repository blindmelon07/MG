    ...
    return (
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4">
                <Heading
                    title="Edit Manual"
                    description="Update this entry in the digital school manual."
                />

                <Form
                    {...ManualController.update.form(manual.id)}
...
ManualsEdit.layout = (page: { manual: Manual }) => ({
    breadcrumbs: [
        { title: 'Manuals', href: manualsIndex() },
        { title: 'Edit', href: edit(page.manual.id) },
    ],
});
